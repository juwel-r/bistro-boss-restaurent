...
{isAdmin ? <>
          <NavLink to="/dashboard/admin-home" className="flex items-center gap-2"><FaHome></FaHome> Admin Home</NavLink>
          <NavLink to="/dashboard/add-items" className="flex items-center gap-2"><FaUtensils></FaUtensils> Add Items</NavLink>
          <NavLink to="/dashboard/manage-items" className="flex items-center gap-2"><FaList></FaList> Manage Items</NavLink>
          <NavLink to="/dashboard/manage-bookings" className="flex items-center gap-2"><FaBook/> Manage Bookings</NavLink>
          <NavLink to="/dashboard/all-users" className="flex items-center gap-2"><FaUsers></FaUsers> All Users</NavLink>
</>:<>
          <NavLink to="//dashboard/user-home" className="flex items-center gap-2"><FaHome></FaHome> User Home</NavLink>
