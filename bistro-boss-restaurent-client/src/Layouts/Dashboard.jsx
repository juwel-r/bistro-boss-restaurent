    ...
    <div className="flex">
      <div className="w-72 bg-yellow-600 min-h-screen px-8 pt-8  fixed">
        ...
        <div className="space-y-2">
          {isAdmin ? (
            ...
            <>
              ...
              <NavLink to="/dashboard/cart" className="flex items-center gap-2 px-2">
        ...
        <div className="space-y-2">
          ...
          <NavLink to="/menu" className="flex items-center gap-2 px-2">
            {" "}
            <GiHamburgerMenu /> Menu
          </NavLink>
          <NavLink to="/order/salad" className="flex items-center gap-2 px-2">
            <FaShopify /> Shop
          </NavLink>
          <NavLink to="/contact" className="flex items-center gap-2 px-2">
            {" "}
      ...
      <div className="w-full flex-1  pl-72 bg-gray-100">
        <Outlet></Outlet>
      </div>
    </div>
  );
